...
public class PunchBehaviour : StateMachineBehaviour
{
    ...
    public MarioController.PunchType m_PunchType;
    ...
    {
        bool m_Enabled = stateInfo.normalizedTime>=m_EnablePunchStartAnimationPct && stateInfo.normalizedTime<= m_EnablePunchEndAnimationPct;
        m_MarioController.EnableHitCollider(m_PunchType, m_Enabled);
    }
